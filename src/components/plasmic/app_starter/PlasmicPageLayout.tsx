...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: BTd4ws15ALB8/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: AkTYUuTFfepT/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: dDZGoufgjuEQ/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__v6LuA)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
        ...
        __composite["1"]["path"] = `/new-page`;
        __composite["1"]["name"] = "New";
        return __composite;
      })()}
      simpleNavTheme={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox___8ArD)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__gcPd)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__vkuj)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__nmI60)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
